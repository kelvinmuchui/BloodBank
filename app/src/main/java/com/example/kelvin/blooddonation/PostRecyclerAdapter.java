...
import com.example.kelvin.blooddonation.Model.Post;
...
public class PostRecyclerAdapter extends RecyclerView.Adapter<PostRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final String blogPostId = post_list.get(position).PostId;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView postShareBtn;
        ...
        public ViewHolder(View itemView) {
            ...
            btnrespond = mView.findViewById(R.id.btnRespond);
            postShareBtn = mView.findViewById(R.id.btnShare);
